...
public:
    ...
    virtual void updateAudioData(ofxFFTData &audioData, float *dataNew);// se agrego int key para interaccion con el teclado
...
// estas variables fueron agregadas para la graficación del cubo flotante
    float xx,yy,r,vX,vY,dirX, dirY;
